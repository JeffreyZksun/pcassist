...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	{
		Action* pAction = new MakeDirectoryLinkAction();
	...
	{
		Action* pAction = new CopyFolderAction();
	...
	{
		Action* pAction = new DeleteFileAction();
	...
	{
		Action* pAction = new CopyFileAction();
